...
inline void emm_ctx_clear_guti(emm_context_t *const ctxt)
{
  ...
  OAILOG_DEBUG(
    LOG_NAS_EMM,
    "ue_id=" MME_UE_S1AP_ID_FMT " GUTI cleared\n",
...
inline void emm_ctx_clear_old_guti(emm_context_t *const ctxt)
{
  ...
  OAILOG_DEBUG(
    LOG_NAS_EMM,
    "ue_id=" MME_UE_S1AP_ID_FMT " old GUTI cleared\n",
    (PARENT_STRUCT(ctxt, struct ue_mm_context_s, emm_context))->mme_ue_s1ap_id);
}
...
inline void emm_ctx_clear_imsi(emm_context_t *const ctxt)
{
  ...
  OAILOG_DEBUG(
    LOG_NAS_EMM,
    "ue_id=" MME_UE_S1AP_ID_FMT " cleared IMSI\n",
    (PARENT_STRUCT(ctxt, struct ue_mm_context_s, emm_context))->mme_ue_s1ap_id);
}

/* Set IMSI */
inline void
emm_ctx_set_imsi(emm_context_t *const ctxt, imsi_t *imsi, const imsi64_t imsi64)
{
  ctxt->_imsi = *imsi;
  ctxt->_imsi64 = imsi64;
...
inline void emm_ctx_clear_imei(emm_context_t *const ctxt)
{
  ...
  OAILOG_DEBUG(
    LOG_NAS_EMM,
    "ue_id=" MME_UE_S1AP_ID_FMT " IMEI cleared\n",
    (PARENT_STRUCT(ctxt, struct ue_mm_context_s, emm_context))->mme_ue_s1ap_id);
}
...
inline void emm_ctx_clear_imeisv(emm_context_t *const ctxt)
{
  ...
  OAILOG_DEBUG(
    LOG_NAS_EMM,
    "ue_id=" MME_UE_S1AP_ID_FMT " cleared IMEI_SV \n",
    (PARENT_STRUCT(ctxt, struct ue_mm_context_s, emm_context))->mme_ue_s1ap_id);
}
...
inline void emm_ctx_clear_auth_vector(emm_context_t *const ctxt, ksi_t eksi)
{
  ...
  memset(
    (void *) &ctxt->_vector[eksi % MAX_EPS_AUTH_VECTORS],
    0,
...
{
  memset(
    &ctxt->_eps_bearer_context_status,
    0,
...
inline void emm_ctx_set_mobile_station_clsMark2(
  emm_context_t *const ctxt,
  MobileStationClassmark2 *mob_st_clsMark2)
{
  ...
  guti_t *guti)
{
  ...
  if (emm_context_p) {
    OAILOG_DEBUG(
      LOG_NAS_EMM,
      "EMM-CTX - get UE id " MME_UE_S1AP_ID_FMT " context %p by guti " GUTI_FMT
      "\n",
      ue_mm_context->mme_ue_s1ap_id,
      emm_context_p,
      GUTI_ARG(guti));
...
//------------------------------------------------------------------------------
void emm_context_silently_reset_procedures(struct emm_context_s *const emm_ctx)
{
  ...
  const bool init_esm_ctxt)
{
  ...
  OAILOG_DEBUG(
    LOG_NAS_EMM,
    "UE " MME_UE_S1AP_ID_FMT " Init EMM-CTX\n",
    ue_mm_context->mme_ue_s1ap_id);
  ...
  void *timer_callback_args)
{
  if ((T3450) && (T3450->id == NAS_TIMER_INACTIVE_ID)) {
    ...
    if (NAS_TIMER_INACTIVE_ID != T3450->id) {
      ...
      OAILOG_ERROR(
        LOG_NAS_EMM, "Could not start T3450 UE " MME_UE_S1AP_ID_FMT " ", ue_id);
    }
  }
}
//------------------------------------------------------------------------------
  ...
  void *timer_callback_args)
{
  if ((T3460) && (T3460->id == NAS_TIMER_INACTIVE_ID)) {
    ...
    if (NAS_TIMER_INACTIVE_ID != T3460->id) {
      ...
      OAILOG_ERROR(
        LOG_NAS_EMM, "Could not start T3460 UE " MME_UE_S1AP_ID_FMT " ", ue_id);
    }
  }
}
//------------------------------------------------------------------------------
  ...
  void *timer_callback_args)
{
  if ((T3470) && (T3470->id == NAS_TIMER_INACTIVE_ID)) {
    ...
    if (NAS_TIMER_INACTIVE_ID != T3470->id) {
      ...
      OAILOG_ERROR(
        LOG_NAS_EMM, "Could not start T3470 UE " MME_UE_S1AP_ID_FMT " ", ue_id);
    }
  }
}
//------------------------------------------------------------------------------
  ...
  bstring bstr_dump)
{
  ...
  bformata(
    bstr_dump,
    "%*s - EMM-CTX: ue id:           " MME_UE_S1AP_ID_FMT " (UE identifier)\n",
    indent_spaces,
    " ",
  ...
  bformata(
    ...
    indent_spaces,
    " ",
    emm_context->is_dynamic);
  bformata(
    bstr_dump,
    "%*s     - is_attached:      %u      (Attachment indicator)\n",
    indent_spaces,
    " ",
    emm_context->is_attached);
  bformata(
    bstr_dump,
  ...
  if (IS_EMM_CTXT_PRESENT_IMEISV(emm_context)) {
    bformata(
      ...
      indent_spaces,
      " ",
      emm_context->_imeisv.u.num.tac1,
      emm_context->_imeisv.u.num.tac2,
      emm_context->_imeisv.u.num.tac3,
      emm_context->_imeisv.u.num.tac4,
      emm_context->_imeisv.u.num.tac5,
      emm_context->_imeisv.u.num.tac6,
      emm_context->_imeisv.u.num.tac7,
      emm_context->_imeisv.u.num.tac8,
      emm_context->_imeisv.u.num.snr1,
      emm_context->_imeisv.u.num.snr2,
      emm_context->_imeisv.u.num.snr3,
      emm_context->_imeisv.u.num.snr4,
      emm_context->_imeisv.u.num.snr5,
      emm_context->_imeisv.u.num.snr6,
      emm_context->_imeisv.u.num.svn1,
  ...
  if (IS_EMM_CTXT_PRESENT_GUTI(emm_context)) {
    ...
    bformata(
      bstr_dump,
      "%*s     - GUTI............: | %08x |  %02x  |  %04x  | %u%u%u | %u%u%c "
      "|\n",
      indent_spaces,
      " ",
      emm_context->_guti.m_tmsi,
      emm_context->_guti.gummei.mme_code,
  ...
  if (IS_EMM_CTXT_PRESENT_OLD_GUTI(emm_context)) {
    ...
    bformata(
      bstr_dump,
      "%*s     - OLD GUTI........: | %08x |  %02x  |  %04x  | %u%u%u | %u%u%c "
      "|\n",
      indent_spaces,
      " ",
      emm_context->_old_guti.m_tmsi,
    ...
    switch (emm_context->_tai_list.partial_tai_list[k].typeoflist) {
      ...
      case TRACKING_AREA_IDENTITY_LIST_ONE_PLMN_CONSECUTIVE_TACS:
        bformata(
          bstr_dump,
          "%*s     - tai:              " TAI_FMT
          "+%u consecutive tacs   (Tracking area identity the UE is registered "
          "to)\n",
          indent_spaces,
          " ",
      ...
      case TRACKING_AREA_IDENTITY_LIST_MANY_PLMNS:
        for (int p = 0;
          ...
          bformata(
            ...
            " ",
            TAI_ARG(
              &emm_context->_tai_list.partial_tai_list[k].u.tai_many_plmn[p]));
        }
        break;
      default:;
    }
  ...
  for (int vector_index = 0; vector_index < MAX_EPS_AUTH_VECTORS;
    ...
    bformata(
      bstr_dump,
      "%*s         - kasme: " KASME_FORMAT "" KASME_FORMAT "\n",
      indent_spaces,
      " ",
  ...
  if (IS_EMM_CTXT_PRESENT_SECURITY(emm_context)) {
    ...
    if (SECURITY_CTX_TYPE_PARTIAL_NATIVE <= emm_context->_security.sc_type) {
      ...
      if (true) {
        ...
        bformata(
          bstr_dump,
          "%*s     - knas_enc: %s     (NAS cyphering key)\n",
          indent_spaces,
          " ",
          key_string);
        ...
        bformata(
          bstr_dump,
          "%*s     - knas_int: %s     (NAS integrity key)\n",
          indent_spaces,
          " ",
          key_string);
        bformata(
        ...
        bformata(
          bstr_dump,
          "%*s     - MS network capabilities TODO\n",
          indent_spaces,
          " ");

        bformata(
          bstr_dump,
          "%*s     - selected_algorithms EEA%u EIA%u\n",
          indent_spaces,
          " ",
