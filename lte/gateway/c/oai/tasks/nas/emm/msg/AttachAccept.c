  ...
  uint32_t len)
{
   ...
   */
  if (
    (decoded_result = decode_u8_eps_attach_result(
       &attach_accept->epsattachresult,
       0,
       *(buffer + decoded),
       len - decoded)) < 0)
  ...
  if (
    (decoded_result = decode_gprs_timer_ie(
  ...
  if (
    (decoded_result = decode_tracking_area_identity_list(
  ...
  if (
    (decoded_result = decode_esm_message_container(
       &attach_accept->esmmessagecontainer,
       0,
       buffer + decoded,
       len - decoded)) < 0)
    return decoded_result;
  ...
  while (len - decoded > 0) {
    ...
    switch (ieiDecoded) {
      ...
      case ATTACH_ACCEPT_MS_IDENTITY_IEI:
        if (
          (decoded_result = decode_mobile_identity_ie(
             &attach_accept->msidentity,
      ...
      case ATTACH_ACCEPT_EMM_CAUSE_IEI:
        if (
          (decoded_result = decode_emm_cause(
             &attach_accept->emmcause,
      ...
      case ATTACH_ACCEPT_EQUIVALENT_PLMNS_IEI:
        if (
          (decoded_result = decode_plmn_list_ie(
      ...
      case ATTACH_ACCEPT_EMERGENCY_NUMBER_LIST_IEI:
        if (
          (decoded_result = decode_emergency_number_list_ie(
      ...
      case ATTACH_ACCEPT_EPS_NETWORK_FEATURE_SUPPORT_IEI:
        if (
          (decoded_result = decode_eps_network_feature_support(
      ...
      case ATTACH_ACCEPT_ADDITIONAL_UPDATE_RESULT_IEI:
        if (
          (decoded_result = decode_additional_update_result(
  ...
  uint32_t len)
{
  ...
  *(buffer + encoded) =
  ...
  if (
    (encode_result = encode_gprs_timer_ie(
  ...
  if (
    (encode_result = encode_tracking_area_identity_list(
  ...
  if (
    ...
    if (
      (encode_result = encode_mobile_identity_ie(
         &attach_accept->msidentity,
         ATTACH_ACCEPT_MS_IDENTITY_IEI,
         buffer + encoded,
         len - encoded)) < 0) {
  ...
  if (
    ...
    if (
      (encode_result = encode_emm_cause(
         &attach_accept->emmcause,
         ATTACH_ACCEPT_EMM_CAUSE_IEI,
         buffer + encoded,
         len - encoded)) < 0) {
  ...
  if (
    ...
    if (
      (encode_result = encode_plmn_list_ie(
         &attach_accept->equivalentplmns,
         ATTACH_ACCEPT_EQUIVALENT_PLMNS_IEI,
         buffer + encoded,
         len - encoded)) < 0) {
  ...
  if (
    ...
    ATTACH_ACCEPT_EMERGENCY_NUMBER_LIST_PRESENT) {
    if (
      (encode_result = encode_emergency_number_list_ie(
         &attach_accept->emergencynumberlist,
         ATTACH_ACCEPT_EMERGENCY_NUMBER_LIST_IEI,
         buffer + encoded,
         len - encoded)) < 0) {
  ...
  if (
    ...
    ATTACH_ACCEPT_EPS_NETWORK_FEATURE_SUPPORT_PRESENT) {
    if (
      (encode_result = encode_eps_network_feature_support(
         &attach_accept->epsnetworkfeaturesupport,
         ATTACH_ACCEPT_EPS_NETWORK_FEATURE_SUPPORT_IEI,
         buffer + encoded,
         len - encoded)) < 0) {
  ...
  if (
    ...
    ATTACH_ACCEPT_ADDITIONAL_UPDATE_RESULT_PRESENT) {
    if (
      (encode_result = encode_additional_update_result(
         &attach_accept->additionalupdateresult,
         ATTACH_ACCEPT_ADDITIONAL_UPDATE_RESULT_IEI,
         buffer + encoded,
         len - encoded)) < 0) {
