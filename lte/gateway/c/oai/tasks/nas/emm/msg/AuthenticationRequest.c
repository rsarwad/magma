  ...
  uint32_t len)
{
  ...
  if (
    (decoded_result = decode_authentication_parameter_rand_ie(
  ...
  if (
    (decoded_result = decode_authentication_parameter_autn_ie(
  ...
  uint32_t len)
{
  ...
  *(buffer + encoded) = ((encode_u8_nas_key_set_identifier(
  ...
  if (
    (encode_result = encode_authentication_parameter_rand_ie(
       authentication_request->authenticationparameterrand,
       0,
       buffer + encoded,
  ...
  if (
    (encode_result = encode_authentication_parameter_autn_ie(
       authentication_request->authenticationparameterautn,
       0,
       buffer + encoded,
       len - encoded)) < 0) //Return in case of error
